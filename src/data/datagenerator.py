    ...
    for fields in classes:   
        ...
        for extension in extension_list:
            ...
            for fl in files:
                ...
                splits=fields.split('_')
                #print(splits[1])
                class_array.append(splits[1])
...
train_path=os.path.join('C:/Downloads/plantgen','train')
...
#batch_size = 32
batch_size=32
def get_data(directory,img_size=32,validation_size = 0.2):
    # Load and read training data
    classes = os.listdir(train_path)
    data = read_train_sets(directory, img_size, classes, validation_size)
